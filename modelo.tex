...
\section{Conclusão} \label{sec:obj}
  ...
  \begin{tikzpicture}[scale=0.8, very thick,->]
    ...
    \draw [color=darkgray, fill=lightgray!50, rounded corners, dashed ] (0.5,2)  node [yshift=-0.7cm, xshift=8.3cm]  {\textbf{\Large Estaleiro}} rectangle (21.5,-0.5);

    \draw [color=olive, fill=green!10, rounded corners, line width=1mm] (1.5,1) node [yshift=-0.7cm, xshift=3cm] {\textbf{\small Nuvem de governo}}  rectangle (9,-7);
    \draw [color=purple, fill=red!10] (2,-1) rectangle node  {\small AWS}  (8.5,-2.5);
    %\node at (2,-1) {texto simples};
    \draw [color=teal, fill=lime!10] (2,-3) rectangle node {\small Google}  (8.5,-4.5);
    \draw [color=darkgray, fill=lightgray!10] (2,-5) rectangle node {\small  Oracle} (8.5,-6.5);
    
    \draw [line width=1mm, color=blue](9,-3) node [anchor=south west] {Transbordo} -- (12.9,-3); 

    \draw [color=brown, fill=yellow!10, rounded corners, line width=1mm] (13,1) node [yshift=-0.7cm, xshift=2.5cm] {\textbf{\small \hspace{6mm} Multicloud}}  rectangle (20.5,-7);
    \draw [color=violet, fill=pink!10, rounded corners] (13.5,-1) rectangle node  {\small  Openstack}  (20,-3.5);
    \draw [color=blue, fill=cyan!10, rounded corners] (13.5,-4) rectangle node  {\small  VMWare}  (20,-6.5);
  ...
  \end{figure}
    ...
    \begin{figure}[!htbp]
      ...
      \\ \hline
      \end{tabular}
      \caption{Exemplo de tkiz \label{fig:soap}}
      \end{center}
     \end{figure}
