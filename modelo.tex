...
\section{Conclusão} \label{sec:obj}
  ...
  \begin{tikzpicture}[scale=0.8, very thick,->]
    ...
    \draw [color=olive, fill=green!10, rounded corners, line width=1mm] (1.5,1) node [yshift=-0.7cm, xshift=3cm] {\textbf{\large Nuvem de governo}}  rectangle (9,-7);
    ...
    \draw [color=brown, fill=yellow!10, rounded corners, line width=1mm] (13,1) node [yshift=-0.7cm, xshift=3 cm] {\textbf{\large Multicloud}}  rectangle (20.5,-7);
